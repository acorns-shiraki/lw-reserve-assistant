---
url: https://developers.worksmobile.com/jp/docs/calendar-default-event-user-create
title: "基本カレンダーの予定の登録 | Developers"
date: 2026-04-01T17:50:18.115Z
lang: ja
---

[LINE WORKS API](/jp/docs/api) [Calendar](/jp/docs/calendar) [予定](/jp/docs/calendar-event-user-create) [基本カレンダーに作成](/jp/docs/calendar-default-event-user-create)

# 基本カレンダーの予定の登録

## POST /users/{userId}/calendar/events[](#i-0)
...
> カテゴリーを設定した予定を取得することでカテゴリー ID を取得できる
...
#### triggerDateTime[](#triggerDateTime-1)
...
](/jp/docs/calendar-event-user-delete)[

次へ

基本カレンダーの予定リスト取得

](/jp/docs/calendar-default-event-user-list)
