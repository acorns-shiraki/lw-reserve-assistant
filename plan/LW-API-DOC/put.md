---
url: https://developers.worksmobile.com/jp/docs/calendar-default-event-user-update-put
title: "基本カレンダーの予定の更新 | Developers"
date: 2026-04-01T17:51:11.756Z
lang: ja
---

[LINE WORKS API](/jp/docs/api) [Calendar](/jp/docs/calendar) [予定](/jp/docs/calendar-event-user-create) [基本カレンダーの予定の更新](/jp/docs/calendar-default-event-user-update-put)

# 基本カレンダーの予定の更新

## PUT /users/{userId}/calendar/events/{eventId}[](#i-0)
...
](/jp/docs/calendar-default-event-user-delete)
