---
url: https://developers.worksmobile.com/jp/docs/calendar-default-event-user-get
title: "基本カレンダーの予定の取得 | Developers"
date: 2026-04-01T17:50:53.577Z
lang: ja
---

[LINE WORKS API](/jp/docs/api) [Calendar](/jp/docs/calendar) [予定](/jp/docs/calendar-event-user-create) [基本カレンダーの予定の取得](/jp/docs/calendar-default-event-user-get)

# 基本カレンダーの予定の取得

## GET /users/{userId}/calendar/events/{eventId}[](#i-0)
